		...
		<div class="flex items-center justify-between">
			...
			{#if userdata}
				<div class="hidden items-center justify-end gap-3 md:flex">
					<a
						class="to inline-flex items-center justify-center rounded-xl bg-linear-0 from-sky-100 to-teal-100 px-3 py-2 text-sm font-semibold text-blue-600 shadow-sm transition-all duration-150 hover:bg-blue-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-blue-600"
						href="/profile">Profile</a
					>
					<a
						class="inline-flex items-center justify-center rounded-xl bg-linear-0 from-red-200 to-yellow-200 px-3 py-2 text-sm font-semibold text-red-700 shadow-sm ring-1 ring-gray-300 transition-all duration-150 ring-inset hover:bg-gray-50"
